; UltimateKEYS SW - KBDUSX - 2020-06-12 (for AutoHotkey v2.0 alpha).ahk
...
; AutoHotkey v2.0-a111-06d0a13b (https://www.autohotkey.com/)
...
dkCaron[chr(0x00e4)] := "{u+00e2}"  ; (ä -> â) a with circumflex
dkCaron[chr(0x00c4)] := "{u+00c2}"  ; (Ä -> Â) A with circumflex
dkCaron[chr(0x00eb)] := "{u+00ea}"  ; (ë -> ê) e with circumflex
dkCaron[chr(0x00cb)] := "{u+00ca}"  ; (Ë -> Ê) E with circumflex
dkCaron[chr(0x00ef)] := "{u+00ee}"  ; (ï -> î) i with circumflex
dkCaron[chr(0x00cf)] := "{u+00ce}"  ; (Ï -> Î) I with circumflex
dkCaron[chr(0x00f6)] := "{u+00f4}"  ; (ö -> ô) o with circumflex
dkCaron[chr(0x00d6)] := "{u+00d4}"  ; (Ö -> Ô) O with circumflex
dkCaron[chr(0x00fc)] := "{u+00fb}"  ; (ü -> û) u with circumflex
dkCaron[chr(0x00dc)] := "{u+00db}"  ; (Ü -> Û) U with circumflex
