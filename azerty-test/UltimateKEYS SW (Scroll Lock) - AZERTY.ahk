; UltimateKEYS SW (Scroll Lock) - AZERTY.ahk - 2021-07-24
...
dkSimpleSymbols.item["A"] := "{u+00aa}"          ; (ª) feminine ordinal indicator (Spanish, Portuguese, Italian, Galician)
dkSimpleSymbols.item[chr(0x00e6)] := "{u+214d}"  ; (æ -> ⅍) aktieselskab
dkSimpleSymbols.item[chr(0x00c6)] := "{u+214d}"  ; (Æ -> ⅍) aktieselskab
