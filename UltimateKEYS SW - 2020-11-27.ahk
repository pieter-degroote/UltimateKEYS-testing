; UltimateKEYS SW - 2020-11-27.ahk
...
dkBreveSpecial.item[chr(0x00e4)] := "{u+0251}"  ; (ä -> ɑ) latin small letter alpha
dkBreveSpecial.item[chr(0x00c4)] := "{u+2c6d}"  ; (Ä -> Ɑ) latin capital letter alpha
