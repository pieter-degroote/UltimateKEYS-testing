; UltimateKEYS SW (Scroll Lock toggle) - 2021-03-12 (for AutoHotkey v2.0 alpha).ahk
...
dkRingDotAbove["q"] := "{u+0227}"  ; (ȧ) a with dot above
dkRingDotAbove["Q"] := "{u+0226}"  ; (Ȧ) A with dot above
