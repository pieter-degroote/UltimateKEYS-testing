; UltimateKEYS SW - KBDUSX - 2020-05-17 (for AutoHotkey v2.0 alpha).ahk
...
$6::Send "{^}{space}"  ; (u+005e) circumflex accent
...
$`::Send "``{space}"   ; (u+0060) grave accent
$~::Send "~{space}"    ; (u+007e) tilde

$'::Send "'{space}"    ; (u+0027) apostrophe
$"::Send "`"{space}"   ; (u+0022) quotation mark
