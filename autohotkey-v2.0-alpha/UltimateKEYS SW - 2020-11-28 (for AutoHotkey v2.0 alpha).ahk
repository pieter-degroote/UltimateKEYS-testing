; UltimateKEYS SW - 2020-11-28 (for AutoHotkey v2.0 alpha).ahk
...
dkDiaeresis[chr(0x00df)] := "{u+017f}"  ; (ß -> ſ) small long s
...
dkMathSymbols[chr(0x00f6)] := "{u+2299}"  ; (ö -> ⊙) circled dot operator
dkMathSymbols[chr(0x00d6)] := "{u+229a}"  ; (Ö -> ⊚) circled ring operator
