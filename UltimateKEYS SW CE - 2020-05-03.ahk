; UltimateKEYS SW CE - 2020-05-03.ahk
...
; Dead Key :  Macron/Math

dkMacronMath := ComObjCreate("Scripting.Dictionary")
dkMacronMath.item("a") := "ā"  ; a with macron
dkMacronMath.item("A") := "Ā"  ; A with macron
dkMacronMath.item("e") := "ē"  ; e with macron
dkMacronMath.item("E") := "Ē"  ; E with macron
dkMacronMath.item("i") := "ī"  ; i with macron
dkMacronMath.item("I") := "Ī"  ; I with macron
dkMacronMath.item("o") := "ō"  ; o with macron
dkMacronMath.item("O") := "Ō"  ; O with macron
dkMacronMath.item("u") := "ū"  ; u with macron
dkMacronMath.item("U") := "Ū"  ; U with macron
dkMacronMath.item("y") := "ȳ"  ; y with macron
dkMacronMath.item("Y") := "Ȳ"  ; Y with macron
dkMacronMath.item("n") := "ⁿ"  ; superscript n
dkMacronMath.item("N") := "ⁿ"  ; superscript n
dkMacronMath.item("1") := "≠"  ; not equal to
dkMacronMath.item("!") := "≠"  ; not equal to
dkMacronMath.item("5") := "‰"  ; per mille sign
dkMacronMath.item("%") := "‰"  ; per mille sign
dkMacronMath.item("8") := "∞"  ; infinity symbol
dkMacronMath.item("*") := "∞"  ; infinity symbol
dkMacronMath.item("``") := "≈" ; almost equal to
dkMacronMath.item("~") := "≈"  ; almost equal to
dkMacronMath.item(",") := "≤"  ; less-than or equal to
dkMacronMath.item("<") := "≤"  ; less-than or equal to
dkMacronMath.item(".") := "≥"  ; greater-than or equal to
dkMacronMath.item(">") := "≥"  ; greater-than or equal to
dkMacronMath.item(" ") := "¬"  ; not sign
