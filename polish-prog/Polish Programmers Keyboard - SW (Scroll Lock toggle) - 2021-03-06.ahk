; Polish Programmers Keyboard - SW (Scroll Lock toggle) - 2021-03-06.ahk
...
dkRingDotAbove.item[chr(0x0105)] := "{u+0227}"  ; (ą -> ȧ) a with dot above
dkRingDotAbove.item[chr(0x0104)] := "{u+0226}"  ; (Ą -> Ȧ) A with dot above
