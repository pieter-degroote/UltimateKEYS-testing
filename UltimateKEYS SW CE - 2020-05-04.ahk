; UltimateKEYS SW CE - 2020-05-04.ahk
...
dkMisc.item("a") := "ā"  ; a with macron
dkMisc.item("A") := "Ā"  ; A with macron
dkMisc.item("e") := "ē"  ; e with macron
dkMisc.item("E") := "Ē"  ; E with macron
dkMisc.item("i") := "ī"  ; i with macron
dkMisc.item("I") := "Ī"  ; I with macron
dkMisc.item("o") := "ō"  ; o with macron
dkMisc.item("O") := "Ō"  ; O with macron
dkMisc.item("u") := "ū"  ; u with macron
dkMisc.item("U") := "Ū"  ; U with macron
dkMisc.item("y") := "ȳ"  ; y with macron
dkMisc.item("Y") := "Ȳ"  ; Y with macron
dkMisc.item("c") := "¤"  ; currency sign
dkMisc.item("C") := "¤"  ; currency sign
dkMisc.item("e") := "…"  ; ellipsis
dkMisc.item("E") := "…"  ; ellipsis
dkMisc.item("n") := "ⁿ"  ; superscript n
dkMisc.item("N") := "ⁿ"  ; superscript n
dkMisc.item("r") := "®"  ; registered sign
dkMisc.item("R") := "®"  ; registered sign
dkMisc.item("s") := "š"  ; s with caron
dkMisc.item("S") := "Š"  ; S with caron
dkMisc.item("z") := "ž"  ; z with caron
dkMisc.item("Z") := "Ž"  ; Z with caron
dkMisc.item("1") := "≠"  ; not equal to
dkMisc.item("!") := "≠"  ; not equal to
dkMisc.item("5") := "‰"  ; per mille sign
dkMisc.item("%") := "‰"  ; per mille sign
dkMisc.item("8") := "∞"  ; infinity symbol
dkMisc.item("*") := "∞"  ; infinity symbol
dkMisc.item("``") := "≈" ; almost equal to
dkMisc.item("~") := "≈"  ; almost equal to
dkMisc.item(",") := "≤"  ; less-than or equal to
dkMisc.item("<") := "≤"  ; less-than or equal to
dkMisc.item(".") := "≥"  ; greater-than or equal to
dkMisc.item(">") := "≥"  ; greater-than or equal to
dkMisc.item(" ") := "¬"  ; not sign
